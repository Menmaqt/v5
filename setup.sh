...
echo -e "$BYellow-------------------------------------------------------------------$NC"
echo -e "$BYellow Pastikan domain sudah pointing dengan ip vps di cloudflare $NC"
echo -e "$BYellow Make sure the domain is already pointing in ip vps on cloudflare $NC"
echo -e "$BYellow-------------------------------------------------------------------$NC"
read -rp "Enter Your Domain / Masukan Domain : " -e pp
    if [ -z $pp ]; then
        echo -e "
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Menmaqt/v5/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Menmaqt/v5/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/Menmaqt/v5/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear

#pasang rc clone ssh ovpn 
echo -e "\e[33m-----------------------------------\033[0m" 
echo -e "$BGreen      Memasang backup server              $NC" 
echo -e "\e[33m-----------------------------------\033[0m" 
sleep 0.5 
clear 
wget https://raw.githubusercontent.com/Menmaqt/v5/main/backup/set-br.sh &&  chmod +x set-br.sh && ./set-br.sh 
clear
